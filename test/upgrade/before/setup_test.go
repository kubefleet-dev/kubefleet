...
=======
		if cond.Type == string(placementv1beta1.ResourcesAvailableConditionType) && cond.Reason == WorkNotAllManifestsTrackableReason  {
>>>>>>> 97d07a3 (Constants Used in place of "NotTrackable")
