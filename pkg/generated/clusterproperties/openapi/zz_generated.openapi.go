...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.MemberClusterProperties":     schema_kubefleet_apis_clusterproperties_v1beta1_MemberClusterProperties(ref),
		"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.MemberClusterPropertiesList": schema_kubefleet_apis_clusterproperties_v1beta1_MemberClusterPropertiesList(ref),
		"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.PropertyValue":               schema_kubefleet_apis_clusterproperties_v1beta1_PropertyValue(ref),
		"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.ResourceUsage":               schema_kubefleet_apis_clusterproperties_v1beta1_ResourceUsage(ref),
...
func schema_kubefleet_apis_clusterproperties_v1beta1_MemberClusterProperties(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MemberClusterProperties is a collection of cluster properties observed for a member cluster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"properties": {
						SchemaProps: spec.SchemaProps{
							Description: "Properties is a collection of non-resource properties observed for the member cluster.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.PropertyValue"),
									},
								},
							},
						},
					...
					"resourceUsage": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.ResourceUsage"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.PropertyValue", "github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.ResourceUsage", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_kubefleet_apis_clusterproperties_v1beta1_MemberClusterPropertiesList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MemberClusterPropertiesList contains a list of MemberClusterProperties.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.MemberClusterProperties"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubefleet-dev/kubefleet/apis/clusterproperties/v1beta1.MemberClusterProperties", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_kubefleet_apis_clusterproperties_v1beta1_PropertyValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"value": {
						SchemaProps: spec.SchemaProps{
							Description: "Value is the value of the cluster property.\n\nCurrently, it should be a valid Kubernetes quantity. For more information, see https://pkg.go.dev/k8s.io/apimachinery/pkg/api/resource#Quantity.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"observationTime": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservationTime is when the cluster property is observed.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
				},
				Required: []string{"value", "observationTime"},
			},
		},
		Dependencies: []string{
...
func schema_kubefleet_apis_clusterproperties_v1beta1_ResourceUsage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ResourceUsage contains the observed resource usage of a member cluster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"capacity": {
						SchemaProps: spec.SchemaProps{
							Description: "Capacity represents the total resource capacity of all the nodes on a member cluster.\n\nA node's total capacity is the amount of resource installed on the node.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"allocatable": {
						SchemaProps: spec.SchemaProps{
							Description: "Allocatable represents the total allocatable resources of all the nodes on a member cluster.\n\nA node's allocatable capacity is the amount of resource that can actually be used for user workloads, i.e., allocatable capacity = total capacity - capacities reserved for the OS, kubelet, etc.\n\nFor more information, see https://kubernetes.io/docs/tasks/administer-cluster/reserve-compute-resources/.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"available": {
						SchemaProps: spec.SchemaProps{
							Description: "Available represents the total available resources of all the nodes on a member cluster.\n\nA node's available capacity is the amount of resource that has not been used yet, i.e., available capacity = allocatable capacity - capacity that has been requested by workloads.\n\nThis field is beta-level; it is for the property-based scheduling feature and is only populated when a property provider is enabled in the deployment.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
