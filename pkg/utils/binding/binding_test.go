...
func TestHasBindingFailed(t *testing.T) {
	tests := []struct {
		...
		{
			name: "binding with reportDiff condition false",
			binding: &placementv1beta1.ClusterResourceBinding{
				ObjectMeta: metav1.ObjectMeta{
					Name:       "test-binding",
					Generation: 1,
		...
		{
			name: "binding with reportDiff condition false but different generation",
			binding: &placementv1beta1.ClusterResourceBinding{
				ObjectMeta: metav1.ObjectMeta{
					Name:       "test-binding",
					Generation: 2,
		...
		{
			name: "binding with reportDiff condition true",
			binding: &placementv1beta1.ClusterResourceBinding{
				ObjectMeta: metav1.ObjectMeta{
					Name:       "test-binding",
					Generation: 1,
		...
		{
			name: "binding with reportDiff condition true but different generation",
			binding: &placementv1beta1.ClusterResourceBinding{
				ObjectMeta: metav1.ObjectMeta{
					Name:       "test-binding",
					Generation: 2,
		...
		{
			name: "binding with multiple conditions including reportDiffall true",
			binding: &placementv1beta1.ClusterResourceBinding{
				ObjectMeta: metav1.ObjectMeta{
					Name:       "test-binding",
					Generation: 1,
