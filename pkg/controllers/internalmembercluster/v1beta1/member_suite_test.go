...
var _ = BeforeSuite(func() {
	...
	// run.
	workApplier1 = workapplier.NewReconciler(hubClient, member1ReservedNSName, nil, nil, nil, nil, 0, 1, nil, true, 60)
	...
	// This controller is created for testing purposes only; no reconciliation loop is actually
	// run.
	workApplier2 = workapplier.NewReconciler(hubClient, member2ReservedNSName, nil, nil, nil, nil, 0, 1, nil, true, 60)
