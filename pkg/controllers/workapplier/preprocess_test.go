			...
			existingManifestConds: []fleetv1beta1.ManifestCondition{
				{
					...
					Conditions: []metav1.Condition{
						manifestAppliedCond(workGeneration, metav1.ConditionTrue, string(ManifestProcessingApplyOrReportDiffResultTypeApplied), ManifestProcessingApplyOrReportDiffResultTypeAppliedDescription),
					},
				},
			},
			wantManifestCondForWA: &fleetv1beta1.ManifestCondition{
	...
	}{
		{
			...
			manifestCondsForWA: []fleetv1beta1.ManifestCondition{
				...
				// Existing manifest.
				{
					...
					Conditions: []metav1.Condition{
						manifestAppliedCond(workGeneration0, metav1.ConditionTrue, string(ManifestProcessingApplyOrReportDiffResultTypeApplied), ManifestProcessingApplyOrReportDiffResultTypeAppliedDescription),
					},
				},
			},
			existingManifestConditions: []fleetv1beta1.ManifestCondition{
				...
				// Manifest condition that corresponds to a gone manifest that failed to be applied.
				{
					...
					Conditions: []metav1.Condition{
						manifestAppliedCond(workGeneration0, metav1.ConditionFalse, string(ManifestProcessingApplyOrReportDiffResultTypeFailedToApply), ""),
					},
				},
