...
func isManifestObjectApplied(appliedResTyp ManifestProcessingApplyOrReportDiffResultType) bool {
	return appliedResTyp == ManifestProcessingApplyOrReportDiffResultTypeApplied ||
		appliedResTyp == ManifestProcessingApplyOrReportDiffResultTypeAppliedWithFailedDriftDetection
}
