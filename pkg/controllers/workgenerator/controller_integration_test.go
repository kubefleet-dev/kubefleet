					...
					Conditions: []metav1.Condition{
						{
							...
							Status:             metav1.ConditionTrue,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeNoDiffFound),
					...
					Conditions: []metav1.Condition{
						{
							Type:               placementv1beta1.WorkConditionTypeDiffReported,
							Status:             metav1.ConditionTrue,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeFoundDiff),
							ObservedGeneration: 1,
							Message:            "",
							LastTransitionTime: now,
						},
					...
					Conditions: []metav1.Condition{
						{
							Type:               placementv1beta1.WorkConditionTypeDiffReported,
							Status:             metav1.ConditionFalse,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeFailedToReportDiff),
							ObservedGeneration: 1,
							Message:            "",
							LastTransitionTime: now,
						},
					...
					Conditions: []metav1.Condition{
						{
							Type:               placementv1beta1.WorkConditionTypeApplied,
							Status:             metav1.ConditionTrue,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeAppliedWithFailedDriftDetection),
							ObservedGeneration: 1,
							Message:            "",
							LastTransitionTime: now,
						},
					...
					Conditions: []metav1.Condition{
						{
							Type:               placementv1beta1.WorkConditionTypeApplied,
							Status:             metav1.ConditionFalse,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeFailedToApply),
							ObservedGeneration: 1,
							Message:            "",
							LastTransitionTime: now,
						},
					...
					Conditions: []metav1.Condition{
						{
							Type:               placementv1beta1.WorkConditionTypeApplied,
							Status:             metav1.ConditionTrue,
							Reason:             string(workapplier.ManifestProcessingApplyOrReportDiffResultTypeApplied),
							ObservedGeneration: 1,
							Message:            "",
							LastTransitionTime: now,
						},
