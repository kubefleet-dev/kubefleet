...
func TestCleanUpAllBindingsFor(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "cluster-scoped placement cleanup with Delete deletion policy",
			placement: func() fleetv1beta1.PlacementObj {
				return &fleetv1beta1.ClusterResourcePlacement{
					ObjectMeta: metav1.ObjectMeta{
						Name:              crpName,
					...
					Spec: fleetv1beta1.PlacementSpec{
						DeletionPolicy: fleetv1beta1.DeletionPolicyDelete,
					},
				}
			},
			existingBindings: []fleetv1beta1.BindingObj{
		...
		{
			name: "cluster-scoped placement cleanup with Orphan deletion policy",
			placement: func() fleetv1beta1.PlacementObj {
				return &fleetv1beta1.ClusterResourcePlacement{
					ObjectMeta: metav1.ObjectMeta{
						Name:              crpName,
					...
					Spec: fleetv1beta1.PlacementSpec{
						DeletionPolicy: fleetv1beta1.DeletionPolicyOrphan,
					},
				}
			},
			existingBindings: []fleetv1beta1.BindingObj{
			...
			wantRemainingBindings: []fleetv1beta1.BindingObj{
				&fleetv1beta1.ClusterResourceBinding{
					ObjectMeta: metav1.ObjectMeta{
						...
						// After finalizer removal, Finalizers field should be empty
					},
				},
			},
		},
		{
			name: "namespaced placement cleanup with Orphan deletion policy",
			placement: func() fleetv1beta1.PlacementObj {
				return &fleetv1beta1.ResourcePlacement{
					ObjectMeta: metav1.ObjectMeta{
						Name:              "test-rp",
