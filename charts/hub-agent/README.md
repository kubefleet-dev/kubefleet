...
| `enablePlacementPolicyAPIs` | Enable the FEP-0001 placement policy APIs (alpha). Disabling it while placement policies hold cluster claims leaves those policies undeletable until it is enabled again. | `false` |
