...
minor receives patches for roughly six months from its initial release. Exact dates may slip
while the project is pre-1.0; the window is always the two most recent minors regardless of dates.
